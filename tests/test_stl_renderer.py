...
from apothecary.projects.parts.part_files import PartFiles, PartFile, FileStatus
...
class TestOpenSCADRenderer:
    ...
    def test_render_stl_openscad_not_available(self, tmp_path):
        ...
        with patch.object(OpenSCADRenderer, 'is_available', new_callable=lambda: property(lambda self: False)):
