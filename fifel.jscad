...
module fifel(){
        ...
        //union combines all the shapes in it to make one larger shape
                ...
                difference() {
                    cylinder(r1=(bore+wall+10)/2, r2=(bore+wall+10)/2, h = height);
                    cylinder(r1=(bore+wall+lipRestHeight-3)/2, r2=(bore+wall+lipRestHeight-3)/2, h = height);
                }
}
